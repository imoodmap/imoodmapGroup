...
<head>
    ...
    <title>情绪日记|记录点滴的你imoodmap</title>
    ...
    $(document).ready(function(){
      ...
      $("#colorfulemotions").focus(function(){
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">iMoodMap</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#about" id="navabout">社区互动</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team" id="navteam">关于我们</a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">给自己和伙伴加油！</h3>
                </div>
            </div>
            <div class="row">
